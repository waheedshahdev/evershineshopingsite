          ...
          ?>
               ...
               <div class="col-md-6 col-md-offset-2 ">
                    <div class="card">
                      ...
                      <form action="<?php echo base_url();?>admin/add_stock/<?php echo $this->uri->segment(3);?>/<?php echo $this->uri->segment(4); ?>" method="post" enctype="multipart/form-data">
                       <div class="col-6">
                        <div class="form-group">
                            <label for="recipient-name" class="control-label">Size</label>
                            <input type="text" name="size" placeholder="Enter Product Size" class="form-control" id="recipient-name1" required>
                        </div>
                    </div>
                    ...
                    <div class="col-6">
                     ...
                     <div class="col-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="size_price" placeholder="Product Price" class="form-control" id="recipient-name1" required>
                        </div>
                    </div>
                    <div class="col-6">
                        <div class="form-group">
                    ...
                    <input type="submit" style="float: right;" name="submit" id="submit" value="Add Size" class="btn btn-success">
